...
def markdown(value, arg=''):
    ...
    To enable unsafe mode, which allows raw HTML not generated by
    actual Markdown syntax, pass "unsafe" as the first extension in
    the list.
    ...
    try:
        ...
        def parse_extra(extra):
            ...
            values = dict(
                (str(val.strip()), True) for val in values.split('|'))
