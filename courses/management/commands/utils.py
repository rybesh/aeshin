...
class MyBaseCommand(BaseCommand):
    ...
    def input_course(self, include_archived=False):
        ...
        while True:
            ...
            try:
                ...
                self.stdout.write(
                    'Please choose one of the course IDs listed above.\n')
    ...
    def input_assignment(self, course):
        ...
        while True:
            ...
            try:
                ...
                self.stdout.write(
                    'Please choose one of the assignment IDs listed above.\n')

    def input_date(self, prompt='YYYY-MM-DD'):
        while True:
            try:
                datestring = input('%s: ' % prompt)
    ...
    def input_choices_index(self, choices):
        ...
        while True:
            try:
                return (int(input('Choice: ')) - 1)
            except (IndexError, TypeError):
                self.stdout.write(
                    'Please choose one of the numbers listed above.\n')
